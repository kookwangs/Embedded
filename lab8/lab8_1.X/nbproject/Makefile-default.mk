...
SOURCEFILES_QUOTED_IF_SPACED=lab8_1.c
...
Device=ATmega328P
ProjectDir=/Users/kookwangs/Desktop/year3\ sem2/Embedded/lab8_1.X
ProjectName=lab8_1
ConfName=default
ImagePath=dist/default/${IMAGE_TYPE}/lab8_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
ImageDir=dist/default/${IMAGE_TYPE}
ImageName=lab8_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
IsDebug="true"
else
IsDebug="false"
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lab8_1.o: lab8_1.c  .generated_files/6cc0521a9c2f85c92f6aa0bc8f3671a80d06fb28.flag .generated_files/bdce24440d613dd06cf048711512069089ab26d1.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab8_1.o.d 
	@${RM} ${OBJECTDIR}/lab8_1.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG  -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp="${DFP_DIR}/xc8"  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -Wall -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3     -MD -MP -MF "${OBJECTDIR}/lab8_1.o.d" -MT "${OBJECTDIR}/lab8_1.o.d" -MT ${OBJECTDIR}/lab8_1.o -o ${OBJECTDIR}/lab8_1.o lab8_1.c 
	
else
${OBJECTDIR}/lab8_1.o: lab8_1.c  .generated_files/ae58b990d1b2fc24afbc592bb170bab89d53cb4e.flag .generated_files/bdce24440d613dd06cf048711512069089ab26d1.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab8_1.o.d 
	@${RM} ${OBJECTDIR}/lab8_1.o 
...
dist/${CND_CONF}/${IMAGE_TYPE}/lab8_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}/avr-objcopy -O ihex "dist/${CND_CONF}/${IMAGE_TYPE}/lab8_1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "dist/${CND_CONF}/${IMAGE_TYPE}/lab8_1.X.${IMAGE_TYPE}.hex"
endif
